...
process.TFileService=cms.Service("TFileService",
        fileName=cms.string("SSBTree_ele.root"),
...
process.jec = cms.ESSource("PoolDBESSource",CondDBSetup,
                           connect = cms.string("sqlite_fip:CMSAnalyses/SSBAnalyzer/data/JECDir/Summer16_23Sep2016/Summer16_23Sep2016V3_MC/Summer16_23Sep2016V3_MC.db"),
                           toGet =  cms.VPSet(
        cms.PSet(
