...
if runOnData:
  ...
  fname = 'file:/pnfs/knu.ac.kr/data/cms/store/user/sha/MiniAODSample/MC/Herwig_80X_forMoiond/0045D9EF-67B5-E611-B736-FA163EEF13C9.root'
...
multPhiCorrParams_T1SmearTxy_25ns  = cms.VPSet( pset for pset in multPhiCorrParams_Txy_25ns_v2)
...
if hasattr(process, "patPFMetTxyCorr"):
    ...
    print getattr(process,'patPFMetTxyCorr')
mufix = "MuClean"
