...
print "**** WARNING lcr2.py is being deprecated and will soon go away."
print "**** Users are strongly advised to switch to brilcalc, which will"
print "**** be the production tool for Run 2. "
print "**** Please see http://cern.ch/cmslumisw/brilwsdoc.html "
...
if args.JSON :
    ...
    if args.printLevel > 0 : 
        print "JSON mode: runList={0:s} ".format(runList)
    else :
        print "JSON mode (for run list use --printLevel > 0 )"

    print "nLS={0:d} Integrated Lumi: delivered={1:8.3f} ({2:s}) recorded={3:8.3f} ({4:s})".format(
        nLS,factor*deliveredLumi,unit,factor*recordedLumi,unit)
